...
export default function ContactPage() {
  ...
  return (
    <MainLayout>
      <div dir={isRTL ? 'rtl' : 'ltr'} className={`container mx-auto px-4 py-12 ${isRTL ? 'text-right' : 'text-left'}`}>
          ...
          <div className="mt-12 grid grid-cols-1 lg:grid-cols-3 gap-12">
                ...
                <form onSubmit={handleSubmit} className="bg-white shadow-md rounded-lg p-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="w-full">
                      ...
                      <input
                        className={`w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-transparent ${isRTL ? 'text-right' : 'text-left'}`}
                        type="text"
                        id="name"
                        name="name"
                  ...
                  <div className="mt-6">
                    ...
                    <textarea
                      className={`w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-transparent min-h-32 ${isRTL ? 'text-right' : 'text-left'}`}
                      id="message"
                      name="message"
                      rows={6}
            ...
            <div>
              <div className="bg-gray-50 rounded-lg p-6 shadow-md">
                ...
                <div className={`mt-6 flex ${isRTL ? 'flex-row-reverse' : 'flex-row'} items-start`}>
                ...
                <div className={`mt-4 flex ${isRTL ? 'flex-row-reverse' : 'flex-row'} items-start`}>
                  <div className={`${isRTL ? 'ml-3' : 'mr-3'} mt-1 bg-amber-100 p-2 rounded-full text-amber-600`}>
                    📧
                  </div>
                  <div>
              ...
              <div className="mt-6 bg-white p-4 rounded-lg shadow-md text-center">
                ...
                <p className="text-gray-600">Global News Headquarters</p>
              </div>
            </div>
          </div>
        </div>
