...
export default function ShareButtons({ title, url, locale = 'en' }: ShareButtonsProps) {
  ...
  return (
    <div className={`bg-white rounded-lg shadow-md p-6 sticky top-24 ${isRTL ? 'text-right' : 'text-left'}`}>
      ...
      <div className="flex flex-col gap-3">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-3 px-4 py-3 bg-blue-500 hover:bg-blue-600 text-white rounded-lg transition-colors"
        >
          <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <button
          ...
          className="flex items-center gap-3 px-4 py-3 bg-gray-100 hover:bg-gray-200 text-gray-900 rounded-lg transition-colors"
        >
          {copied ? (
            <>
