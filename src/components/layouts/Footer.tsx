...
export const Footer = () => {
  ...
  const footerData = {
    ...
    legal: {
      ...
      links: [
        { name: { en: 'Terms of Service', ar: 'شروط الخدمة' }, slug: 'terms' },
        { name: { en: 'Privacy Policy', ar: 'سياسة الخصوصية' }, slug: 'privacy' },
        { name: { en: 'Cookie Policy', ar: 'سياسة ملفات تعريف الارتباط' }, slug: 'cookies' },
      ]
    },
  };
